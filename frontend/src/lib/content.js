...
export const CONTENT = {
  it: {
    ...
    prenota: {
      ...
      fallbackBody: "Puoi comunque scriverci direttamente per verificare disponibilità, tariffe e soggiorni su misura.",
      fallbackCta: "Contatta per prenotare",
      form: {
        stayLegend: "01. Il soggiorno",
        guestLegend: "02. Chi sei",
        consentLegend: "03. Consensi",
        room: "Sistemazione",
        roomPlaceholder: "Scegli…",
        comingSoon: "in apertura",
        checkIn: "Arrivo",
        checkOut: "Partenza",
        adults: "Adulti",
        children: "Bambini",
        ...
        messagePlaceholder: "Orario di arrivo, allergie, animali, richieste particolari…",
        privacy: "Ho letto e accetto l'informativa sul trattamento dei dati personali.",
        marketing:
          "Voglio ricevere notizie dall'azienda agricola: raccolti, corsi, aperture. Poche email l'anno.",
        submit: "Invia la richiesta",
        submitting: "Invio in corso…",
        summaryTitle: "Il tuo preventivo",
        summaryRoom: "Sistemazione",
        summaryNights: "Notti",
        summaryGuests: "Ospiti",
        summaryRate: "Tariffa a notte",
        summaryTotal: "Totale stimato",
        summaryNote:
          "Stima indicativa. Il totale definitivo è quello che confermiamo noi via email.",
        successTitle: "Richiesta ricevuta.",
        successBody:
          "Verifichiamo la disponibilità e ti rispondiamo entro 24 ore. Ti abbiamo inviato una copia via email.",
        errorGeneric: "Non siamo riusciti a registrare la richiesta.",
        errorFields: "Controlla i campi evidenziati e riprova.",
        errorTimeout: "Il server non ha risposto in tempo. Riprova, oppure scrivici direttamente.",
        errorNetwork: "Connessione non riuscita. Scrivici o chiamaci: ti rispondiamo subito.",
        required: "obbligatorio",
        errRoom: "Scegli una sistemazione.",
        errCheckIn: "Indica la data di arrivo.",
        errCheckOut: "Indica la data di partenza.",
        errOrder: "La partenza deve essere dopo l'arrivo.",
        errMinNights: (n) => `Minimo ${n} notti per questa sistemazione.`,
        errMaxGuests: (n) => `Massimo ${n} ospiti per questa sistemazione.`,
        errAdults: "Serve almeno un adulto.",
        errFirstName: "Inserisci il nome.",
        errLastName: "Inserisci il cognome.",
        errEmail: "Inserisci un indirizzo email valido.",
        errPhone: "Numero di telefono non valido.",
        errPrivacy: "Devi accettare l'informativa per proseguire.",
      },
    },
    beeHumus: {
    ...
    shop: {
      ...
      cart: {
        ...
        soldOut: "Esaurito",
        title: "Il tuo ordine",
        empty: "Il carrello è vuoto. Scegli un formato qui sopra.",
        remove: "Togli",
        itemsTotal: "Prodotti",
        shipping: "Spedizione",
        shippingFree: "offerta",
        pickupFree: "ritiro in azienda",
        total: "Totale",
        checkout: "Completa l'ordine",
        deliveryLegend: "Come lo ricevi",
        pickup: "Ritiro in azienda",
        pickupNote: "Loc. Baresi 15, Castiglione Chiavarese — ci accordiamo sull'orario.",
        shippingOption: "Spedizione",
        shippingNote: "€ 7,00 in Italia. Offerta sopra i € 60,00.",
        contactLegend: "I tuoi dati",
        firstName: "Nome",
        lastName: "Cognome",
        email: "Email",
        phone: "Telefono",
        ...
        city: "Città",
        country: "Paese",
        message: "Note per noi",
        messagePlaceholder: "Quando passi a ritirare, confezioni regalo, altro…",
        privacy: "Ho letto e accetto l'informativa sul trattamento dei dati personali.",
        marketing: "Voglio ricevere notizie dall'azienda agricola. Poche email l'anno.",
        submit: "Invia l'ordine",
        submitting: "Invio in corso…",
        successTitle: "Ordine ricevuto.",
        successBody:
          "Ti contattiamo entro 24 ore per concordare pagamento e consegna. Ti abbiamo mandato una copia via email.",
        newOrder: "Nuovo ordine",
        errorFields: "Controlla i campi evidenziati e riprova.",
        errorGeneric: "Non siamo riusciti a registrare l'ordine.",
        errorTimeout: "Il server non ha risposto in tempo. Riprova, oppure scrivici direttamente.",
        errorNetwork: "Connessione non riuscita. Scrivici o chiamaci: ti rispondiamo subito.",
        errFirstName: "Inserisci il nome.",
        errLastName: "Inserisci il cognome.",
        errEmail: "Inserisci un indirizzo email valido.",
        errPhone: "Numero di telefono non valido.",
        errAddress: "Inserisci l'indirizzo di spedizione.",
        errCity: "Inserisci la città.",
        errPrivacy: "Devi accettare l'informativa per proseguire.",
        errEmpty: "Aggiungi almeno un vasetto.",
      },
    },
    raccolti: {
  ...
  en: {
    ...
    prenota: {
      ...
      fallbackTitle: "The booking widget is temporarily unavailable.",
      fallbackBody: "You can still contact us directly to check availability, rates and tailored stays.",
      fallbackCta: "Contact us to book",
      form: {
        stayLegend: "01. Your stay",
        guestLegend: "02. About you",
        consentLegend: "03. Consent",
        room: "Accommodation",
        roomPlaceholder: "Choose…",
        ...
        messagePlaceholder: "Arrival time, allergies, pets, special requests…",
        privacy: "I have read and accept the personal data processing notice.",
        marketing:
          "Send me news from the farm: harvests, courses, openings. A few emails a year.",
        submit: "Send request",
        submitting: "Sending…",
        summaryTitle: "Your estimate",
        summaryRoom: "Accommodation",
        summaryNights: "Nights",
        summaryGuests: "Guests",
        summaryRate: "Rate per night",
        summaryTotal: "Estimated total",
        summaryNote: "Indicative estimate. The final total is the one we confirm by email.",
        successTitle: "Request received.",
        successBody:
          "We check availability and reply within 24 hours. A copy is on its way to your inbox.",
        errorGeneric: "We could not register your request.",
        errorFields: "Please check the highlighted fields and try again.",
        errorTimeout: "The server did not respond in time. Try again, or contact us directly.",
        errorNetwork: "Connection failed. Write or call us: we reply straight away.",
        required: "required",
        errRoom: "Choose an accommodation.",
        errCheckIn: "Enter the arrival date.",
        errCheckOut: "Enter the departure date.",
        errOrder: "Departure must come after arrival.",
        errMinNights: (n) => `Minimum ${n} nights for this accommodation.`,
        errMaxGuests: (n) => `Maximum ${n} guests for this accommodation.`,
        errAdults: "At least one adult is required.",
        errFirstName: "Enter your first name.",
        errLastName: "Enter your last name.",
        errEmail: "Enter a valid email address.",
        errPhone: "Invalid phone number.",
        errPrivacy: "You must accept the notice to continue.",
      },
    },
    beeHumus: {
    ...
    shop: {
      ...
      cart: {
        ...
        soldOut: "Sold out",
        title: "Your order",
        empty: "Your cart is empty. Pick a size above.",
        remove: "Remove",
        itemsTotal: "Products",
        shipping: "Shipping",
        shippingFree: "free",
        pickupFree: "pickup at the farm",
        total: "Total",
        checkout: "Complete your order",
        deliveryLegend: "How you get it",
        pickup: "Pickup at the farm",
        pickupNote: "Loc. Baresi 15, Castiglione Chiavarese — we agree on a time.",
        shippingOption: "Shipping",
        shippingNote: "€ 7.00 within Italy. Free over € 60.00.",
        ...
        messagePlaceholder: "When you are coming to collect, gift wrapping, anything else…",
        privacy: "I have read and accept the personal data processing notice.",
        marketing: "Send me news from the farm. A few emails a year.",
        submit: "Send order",
        submitting: "Sending…",
        successTitle: "Order received.",
        successBody:
          "We get in touch within 24 hours to arrange payment and delivery. A copy is on its way to your inbox.",
        newOrder: "New order",
        errorFields: "Please check the highlighted fields and try again.",
        errorGeneric: "We could not register your order.",
        errorTimeout: "The server did not respond in time. Try again, or contact us directly.",
        errorNetwork: "Connection failed. Write or call us: we reply straight away.",
        errFirstName: "Enter your first name.",
        errLastName: "Enter your last name.",
        errEmail: "Enter a valid email address.",
        errPhone: "Invalid phone number.",
        errAddress: "Enter the shipping address.",
        errCity: "Enter the city.",
        errPrivacy: "You must accept the notice to continue.",
        errEmpty: "Add at least one jar.",
      },
    },
    raccolti: {
